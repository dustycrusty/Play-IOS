...
class listPage_bowlingcafe: UIViewController, UITableViewDataSource, UITableViewDelegate, CLLocationManagerDelegate {
...
//                }
    ...
    func numberOfSections(in tableView: UITableView) -> Int {
        ...
        else
        {
            ...
            noDataLabel.text          = "주변에 볼링장을 못찾았어요ㅠ.ㅠ"
...
//    }
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if indexPath.section == 0 || indexPath.section == 1{
            ...
            controller.navigationItem.title = "가게 정보"
...
extension listPage_bowlingcafe: UISearchResultsUpdating {
